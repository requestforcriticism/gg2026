...
func move_me_to_goldmine(enemy_to_move:PathFollow3D) -> void:
	if enemy_to_move.progress_ratio == 1.0:
		enemy_to_move.reparent(my_going_forward_mine)
	else:
		print("Something went wrong moving ", enemy_to_move, "to ",self)
